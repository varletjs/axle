...
`)])],-1);function w(v,B,g,k,y,A){const l=c("var-site-code-example");return t(),r("div",h,[i,s("div",_,[u,a(l,null,{default:o(()=>[j]),_:1})]),s("div",x,[b,m,a(l,null,{default:o(()=>[f]),_:1})])])}var E=n(d,[["render",w]]);export{E as default};
