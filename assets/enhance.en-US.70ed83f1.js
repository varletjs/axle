import{_ as t}from"./elevation.a8512ead.js";import{e as o,o as c,c as r,a as s,i as l,j as e,m as a}from"./vendor.bb785d67.js";const p={components:{}},i={class:"varlet-site-doc"},h=s("h1",null,"Enhance",-1),j={class:"card"},d=s("h3",null,"Normalize Api Arguments",-1),m=s("p",null,[s("code",null,"Axle"),a(" unifies the input parameter format of the interface, so that developers can focus more on business development. The following are some examples compared with "),s("code",null,"axios"),a(".")],-1),u=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// axios"),a(`
...
`)])],-1),f=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// axle"),a(`
...
`)])],-1);function x(w,g,y,_,k,v){const n=o("var-site-code-example");return c(),r("div",i,[h,s("div",j,[d,m,l(n,null,{default:e(()=>[u]),_:1}),l(n,null,{default:e(()=>[f]),_:1})])])}var H=t(p,[["render",x]]);export{H as default};
