import{_ as t}from"./elevation.a0cf3236.js";import{e as c,o as r,c as o,a as s,i as n,j as e,m as a}from"./vendor.16f6342a.js";const p={components:{}},h={class:"varlet-site-doc"},i=s("h1",null,"Example",-1),j={class:"card"},d=s("h3",null,"Normalize Api Arguments",-1),m=s("pre",{class:"hljs"},[s("code",null,[s("link",{class:"hljs-style",rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// axios"),a(`
...
`)])],-1);function x(f,_,w,y,g,k){const l=c("var-site-code-example");return r(),o("div",h,[i,s("div",j,[d,n(l,null,{default:e(()=>[m]),_:1}),n(l,null,{default:e(()=>[u]),_:1})])])}var D=t(p,[["render",x]]);export{D as default};
