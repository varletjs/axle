...
`)])],-1);function w(v,k,g,J,A,H){const a=t("var-site-code-example");return c(),p("div",d,[h,s("div",_,[u,l(a,null,{default:n(()=>[j]),_:1})]),s("div",x,[f,m,l(a,null,{default:n(()=>[y]),_:1})])])}var T=o(i,[["render",w]]);export{T as default};
