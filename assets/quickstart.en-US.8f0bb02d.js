import{_ as t,s as c,f as o,h as r,l as s,t as n,P as l,M as a}from"./elevation.944bba77.js";const p={components:{}},h={class:"varlet-site-doc"},d=s("h1",null,"Quickstart",-1),i={class:"card"},m=s("h3",null,"Install",-1),_=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," Install with npm, yarn or pnpm"),a(`
...
`)])],-1);function j(u,f,v,w,k,y){const e=c("var-site-code-example");return o(),r("div",h,[d,s("div",i,[m,n(e,null,{default:l(()=>[_]),_:1}),n(e,null,{default:l(()=>[x]),_:1})])])}var $=t(p,[["render",j]]);export{$ as default};
