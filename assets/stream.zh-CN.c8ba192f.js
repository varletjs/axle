...
`)])],-1);function y(k,S,g,v,A,H){const l=c("var-site-code-example");return o(),r("div",h,[i,s("div",_,[m,a(l,null,{default:t(()=>[u]),_:1})]),s("div",j,[x,f,a(l,null,{default:t(()=>[w]),_:1})])])}var T=n(p,[["render",y]]);export{T as default};
