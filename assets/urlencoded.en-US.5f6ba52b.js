...
`)])],-1);function y(v,k,g,A,H,P){const a=t("var-site-code-example");return c(),r("div",i,[h,s("div",_,[u,l(a,null,{default:n(()=>[j]),_:1})]),s("div",x,[f,m,l(a,null,{default:n(()=>[w]),_:1})])])}var M=o(d,[["render",y]]);export{M as default};
