...
export function createAxle(
  ...
  function removeHeader(key: string | string[]) {
    ...
    key.forEach(
      (k) => Reflect.deleteProperty(service.defaults.headers["common"] as AxiosRequestHeaders,k)
    );
  }
